...
static void source_pos(test_batch_runner *runner) {
  ...
  STR_EQ(runner, xml, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                      ...
                      "  </paragraph>\n"
                      "  <paragraph sourcepos=\"3:1-4:34\">\n"
                      "    <text sourcepos=\"3:1-3:6\">Hello </text>\n"
                      "    <link sourcepos=\"3:7-3:29\" destination=\"http://www.google.com\" title=\"\">\n"
                      "      <text sourcepos=\"3:8-3:28\">http://www.google.com</text>\n"
                      "    </link>\n"
                      "    <softbreak />\n"
                      "    <text sourcepos=\"4:1-4:6\">there </text>\n"
                      "    <link sourcepos=\"4:7-4:33\" destination=\"www.google.com\" title=\"ok\">\n"
                      "      <text sourcepos=\"4:8-4:11\">okay</text>\n"
                      "    </link>\n"
