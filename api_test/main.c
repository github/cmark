...
static void ext_source_pos(test_batch_runner *runner) {
  ...
  STR_EQ(runner, xml, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                      ...
                      "    </paragraph>\n"
                      "  </block_quote>\n"
                      "  <table sourcepos=\"5:1-7:15\">\n"
                      "    <table_header sourcepos=\"5:1-5:15\">\n"
                      "      <table_cell sourcepos=\"5:1-5:5\">\n"
                      "        <text sourcepos=\"5:3-5:3\">a</text>\n"
                      "      </table_cell>\n"
                      "      <table_cell sourcepos=\"5:5-5:9\">\n"
                      "        <text sourcepos=\"5:7-5:7\">b</text>\n"
                      "      </table_cell>\n"
                      "      <table_cell sourcepos=\"5:9-5:15\">\n"
                      "        <emph sourcepos=\"5:11-5:13\">\n"
                      "          <text sourcepos=\"5:12-5:12\">c</text>\n"
                      "        </emph>\n"
                      "      </table_cell>\n"
                      "    </table_header>\n"
                      "    <table_row sourcepos=\"7:1-7:15\">\n"
                      "      <table_cell sourcepos=\"7:1-7:5\">\n"
                      "        <text sourcepos=\"7:3-7:3\">1</text>\n"
                      "      </table_cell>\n"
                      "      <table_cell sourcepos=\"7:5-7:9\">\n"
                      "        <text sourcepos=\"7:7-7:7\">2</text>\n"
                      "      </table_cell>\n"
                      "      <table_cell sourcepos=\"7:9-7:15\">\n"
                      "        <strikethrough sourcepos=\"7:11-7:13\">\n"
                      "          <text sourcepos=\"7:12-7:12\">3</text>\n"
                      "        </strikethrough>\n"
                      "      </table_cell>\n"
                      "    </table_row>\n"
                      "  </table>\n"
